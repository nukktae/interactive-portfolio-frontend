...
import { friendlyStructure } from './friendly.structure';
import { friendlyEN } from './friendly.en';
import { friendlyKO } from './friendly.ko';
...
function buildOverviewContent(content: typeof friendlyEN.overview): React.ReactNode {
...
function buildFriendlyContent(lang: 'en' | 'ko'): ProjectDetailContent {
  const content = lang === 'ko' ? friendlyKO : friendlyEN;
  const structure = friendlyStructure;
...
export function getFriendlyContent(lang: 'en' | 'ko'): ProjectDetailContent {
  return buildFriendlyContent(lang);
}

export const friendlyContent = getFriendlyContent('en');
