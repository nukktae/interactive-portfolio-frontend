...
import { shinhanStructure } from './shinhan.structure';
import { shinhanEN } from './shinhan.en';
import { shinhanKO } from './shinhan.ko';
...
function buildOverviewContent(content: typeof shinhanEN.overview): React.ReactNode {
...
function buildShinhanContent(lang: 'en' | 'ko'): ProjectDetailContent {
  const content = lang === 'ko' ? shinhanKO : shinhanEN;
  const structure = shinhanStructure;
...
export function getShinhanContent(lang: 'en' | 'ko'): ProjectDetailContent {
  return buildShinhanContent(lang);
}

export const shinhanContent = getShinhanContent('en');
