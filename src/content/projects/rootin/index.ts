...
import { rootinStructure } from './rootin.structure';
import { rootinEN } from './rootin.en';
import { rootinKO } from './rootin.ko';
...
function buildOverviewContent(content: typeof rootinEN.overview): React.ReactNode {
...
function buildRootinContent(lang: 'en' | 'ko'): ProjectDetailContent {
  const content = lang === 'ko' ? rootinKO : rootinEN;
  const structure = rootinStructure;
...
export function getRootinContent(lang: 'en' | 'ko'): ProjectDetailContent {
  return buildRootinContent(lang);
}

export const rootinContent = getRootinContent('en');
