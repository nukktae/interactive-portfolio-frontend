...
import { awsContentModerationStructure } from './aws-content-moderation.structure';
import { awsContentModerationEN } from './aws-content-moderation.en';
import { awsContentModerationKO } from './aws-content-moderation.ko';
...
function buildOverviewContent(content: typeof awsContentModerationEN.overview): React.ReactNode {
...
function buildAwsContentModerationContent(lang: 'en' | 'ko'): ProjectDetailContent {
  const content = lang === 'ko' ? awsContentModerationKO : awsContentModerationEN;
  const structure = awsContentModerationStructure;
...
export function getAwsContentModerationContent(lang: 'en' | 'ko'): ProjectDetailContent {
  return buildAwsContentModerationContent(lang);
}

export const awsContentModerationContent = getAwsContentModerationContent('en');
