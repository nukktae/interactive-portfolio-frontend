...
import { Code, Database, Smartphone, BarChart3, Users, Zap, Shield, Layers, TrendingUp, Award, Brain, Mail, FileText, Sparkles, Component, LayoutTemplate, Workflow, MapPin, Cloud } from 'lucide-react';
import { SiGithub, SiNextdotjs, SiReact, SiTypescript, SiTailwindcss, SiVercel, SiGooglemaps } from 'react-icons/si';
import { moveparkStructure } from './movepark.structure';
import { moveparkEN } from './movepark.en';
import { moveparkKO } from './movepark.ko';

const iconMap: Record<string, any> = {
  Code, Database, Smartphone, BarChart3, Users, Zap, Shield, Layers, TrendingUp, Award, Brain, Mail, FileText, Sparkles, Component, LayoutTemplate, Workflow, MapPin, Cloud, SiGithub, SiNextdotjs, SiReact, SiTypescript, SiTailwindcss, SiVercel, SiGooglemaps
};
...
function buildOverviewContent(content: typeof moveparkEN.overview): React.ReactNode {
...
function buildMoveparkContent(lang: 'en' | 'ko'): ProjectDetailContent {
  const content = lang === 'ko' ? moveparkKO : moveparkEN;
  const structure = moveparkStructure;
...
export function getMoveparkContent(lang: 'en' | 'ko'): ProjectDetailContent {
  return buildMoveparkContent(lang);
}

export const moveparkContent = getMoveparkContent('en');
