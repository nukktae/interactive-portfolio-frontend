...
import { majormatchAiStructure } from './majormatch-ai.structure';
import { majorMatchEN } from './majormatch-ai.en';
import { majorMatchKO } from './majormatch-ai.ko';
...
function buildOverviewContent(content: typeof majorMatchEN.overview): React.ReactNode {
...
function buildMajormatchAiContent(lang: 'en' | 'ko'): ProjectDetailContent {
  const content = lang === 'ko' ? majorMatchKO : majorMatchEN;
  const structure = majormatchAiStructure;
...
export function getMajormatchAiContent(lang: 'en' | 'ko'): ProjectDetailContent {
  return buildMajormatchAiContent(lang);
}

export const majormatchAiContent = getMajormatchAiContent('en');
