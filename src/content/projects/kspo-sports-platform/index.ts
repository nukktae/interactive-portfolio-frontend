...
import { kspoSportsPlatformStructure } from './kspo-sports-platform.structure';
import { kspoSportsPlatformEN } from './kspo-sports-platform.en';
import { kspoSportsPlatformKO } from './kspo-sports-platform.ko';
...
function buildOverviewContent(content: typeof kspoSportsPlatformEN.overview): React.ReactNode {
...
function buildKspoSportsPlatformContent(lang: 'en' | 'ko'): ProjectDetailContent {
  const content = lang === 'ko' ? kspoSportsPlatformKO : kspoSportsPlatformEN;
  const structure = kspoSportsPlatformStructure;
...
export function getKspoSportsPlatformContent(lang: 'en' | 'ko'): ProjectDetailContent {
  return buildKspoSportsPlatformContent(lang);
}

export const kspoSportsPlatformContent = getKspoSportsPlatformContent('en');
