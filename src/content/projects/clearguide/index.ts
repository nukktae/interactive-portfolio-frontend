...
import { clearguideStructure } from './clearguide.structure';
import { clearguideEN } from './clearguide.en';
import { clearguideKO } from './clearguide.ko';
...
function buildOverviewContent(content: typeof clearguideEN.overview): React.ReactNode {
...
function buildClearguideContent(lang: 'en' | 'ko'): ProjectDetailContent {
  const content = lang === 'ko' ? clearguideKO : clearguideEN;
  const structure = clearguideStructure;
...
export function getClearguideContent(lang: 'en' | 'ko'): ProjectDetailContent {
  return buildClearguideContent(lang);
}

export const clearguideContent = getClearguideContent('en');
