      ...
      <div className="max-w-7xl mx-auto px-4">
        <div className="flex flex-col lg:flex-row items-center gap-12">
          ...
          <div className="relative w-[300px] h-[600px] flex-shrink-0">
            ...
            <button
              onClick={prevSlide}
              className="absolute left-[-60px] top-1/2 -translate-y-1/2 p-3 bg-blue-500/10 hover:bg-blue-500/20 rounded-full text-white transition-colors backdrop-blur-sm"
            >
              <FaChevronLeft size={24} />
            </button>
            <button
              onClick={nextSlide}
              className="absolute right-[-60px] top-1/2 -translate-y-1/2 p-3 bg-blue-500/10 hover:bg-blue-500/20 rounded-full text-white transition-colors backdrop-blur-sm"
            >
