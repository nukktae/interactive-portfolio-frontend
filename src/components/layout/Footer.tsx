...
export default function Footer() {
  ...
  return (
    <footer className="py-16 border-t border-border relative z-10" ref={ref}>
      <div className="px-6 md:px-12 lg:px-20 xl:px-32 max-w-[1800px] mx-auto">
        ...
        >
          {/* Logo */}
          <div className="text-3xl font-black uppercase tracking-tight text-foreground">
            ANU
          </div>

          {/* Links */}
          <div className="flex gap-8 text-sm font-bold tracking-widest text-foreground/60 uppercase">
            ...
            <a href="#tech-stack" className="hover:text-foreground transition-colors duration-300">
              SERVICES
            </a>
        ...
        >
          <div className="text-[12rem] md:text-[16rem] lg:text-[20rem] font-black text-foreground/5 leading-none">
            DEVELOPER
          </div>
        </motion.div>
      </div>
